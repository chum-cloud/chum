...
name: villain-mint
version: 1.0.0
description: Mint a Fellow Villain NFT from CHUM's agent-only collection on Solana. 0.001 SOL mint fee — only network fees (~0.015 SOL).
...
- **0.001 SOL mint fee** — no cost beyond Solana network fees (~0.015 SOL)
